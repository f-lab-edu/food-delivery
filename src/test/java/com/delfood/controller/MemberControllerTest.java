...
//
//    mockMvc
//        .perform(post("/members/").contentType(MediaType.APPLICATION_JSON_UTF8)
...
//
//    mockMvc
//        .perform(post("/members/signIn").session(mockSession)
//            .contentType(MediaType.APPLICATION_JSON).content(mapper.writeValueAsString(memberInfo)))
//        .andDo(print()).andExpect(status().isOk());
//
//    memberInfo.setPassword("failPassword");
//    mockMvc
//        .perform(post("/members/signIn").contentType(MediaType.APPLICATION_JSON)
//            .content(mapper.writeValueAsString(memberInfo)))
...
//    mockMvc.perform(get("/members/idCheck/testID")).andDo(print())
//        .andExpect(jsonPath("$.result", is("duplicated"))).andExpect(status().isLocked());
//  }
//
//
//  @Test
...
//
//    mockMvc
//        .perform(post("/members/").contentType(MediaType.APPLICATION_JSON)
//            .content(mapper.writeValueAsString(memberInfo)))
//        .andDo(print()).andExpect(status().isLocked())
...
//    mockMvc
//        .perform(
//            put("/members/password").param("password", "updatePassword").sessionAttrs(sessionAttr))
//        .andDo(print()).andExpect(jsonPath("$.result", is("success"))).andExpect(status().isOk());
//  }
//
//
