 ...
 * 
 * @ExceptionHandler({Exception1.class, Exception2.class}) - @Controller, @RestController에서 사용 가능 -
 * 컨트롤러 클래스 내에서 발생하는 예외를 해당 어노테이션이 적용된 메서드를 통해 처리한다.
 * 
 * @ControllerAdvice ( @RestControllerAdvice ) - 모든 @Controller 또는 @RestController에 적용되는 공통클래스를 만들 때
 * 사용한다.
 */
